#include "SimpleGreedyLSystemWithBranching.h"

using namespace std;

SimpleGreedyLSystemWithBranching::SimpleGreedyLSystemWithBranching() {
}

cv::Mat_<double> SimpleGreedyLSystemWithBranching::computeDensity(int grid_size, const cv::Mat_<double>& param, bool smooth, bool crossing_check) {
...
void SimpleGreedyLSystemWithBranching::moveForward(cv::Point2d& pt, cv::Mat_<double> density, bool crossing_check) {
	pt.y += 1;
...
void SimpleGreedyLSystemWithBranching::moveLeftForward(cv::Point2d& pt, cv::Mat_<double> density, bool crossing_check) {
	pt.x -= 1;
	pt.y += 1;
...
void SimpleGreedyLSystemWithBranching::moveRightForward(cv::Point2d& pt, cv::Mat_<double> density, bool crossing_check) {
	pt.x += 1;
	pt.y += 1;
