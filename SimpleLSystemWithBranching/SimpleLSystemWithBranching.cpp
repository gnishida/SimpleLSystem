...
SimpleLSystemWithBranching::SimpleLSystemWithBranching() {
}

cv::Mat_<double> SimpleLSystemWithBranching::computeDensity(int grid_size, const cv::Mat_<double>& param, bool smooth, bool crossing_check) {
...
void SimpleLSystemWithBranching::moveForward(cv::Point2d& pt, cv::Mat_<double> density, bool crossing_check) {
	pt.y += 1;
...
void SimpleLSystemWithBranching::moveLeftForward(cv::Point2d& pt, cv::Mat_<double> density, bool crossing_check) {
	pt.x -= 1;
	pt.y += 1;
...
void SimpleLSystemWithBranching::moveRightForward(cv::Point2d& pt, cv::Mat_<double> density, bool crossing_check) {
	pt.x += 1;
	pt.y += 1;
